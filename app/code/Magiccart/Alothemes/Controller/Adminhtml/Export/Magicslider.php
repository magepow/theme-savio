...
class Magicslider extends \Magiccart\Alothemes\Controller\Adminhtml\Action
{
    ...
    public function ExportXml()
    {
        ...
        try{
                ...
                $collection->addFieldToFilter('magicslider_id',array('in'=>$exportIds));
                $options = array('title', 'identifier', 'config', 'status');
