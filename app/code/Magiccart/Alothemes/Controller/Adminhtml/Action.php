 ...
 * @@Modify Date: 2016-05-06 14:08:51
 * @@Function:
 */

namespace Magiccart\Alothemes\Controller\Adminhtml;

abstract class Action extends \Magento\Backend\App\Action
{

    const CMS = 'code/Magiccart/Alothemes/etc/import/%s/'; //'design/frontend/%s/import/';
