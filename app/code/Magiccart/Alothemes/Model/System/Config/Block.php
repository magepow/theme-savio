...
class Block implements \Magento\Framework\Option\ArrayInterface  // extends \Magento\Catalog\Model\Category\Attribute\Source\Page
{
    ...
    public function toOptionArray() {
        if (!$this->_blocks) {
            ...
            array_unshift($options, ['value' => '', 'label' => __('Select a static block')]);
